...
public class King extends Piece {
    ...
    public boolean isValidMove(String curr, String dest) {
        ...
        if(srcC>=0 && srcC<8 && dC>=0 && dC<8  && srcR>=0 && srcR<8 && dR>=0 && dR<8){
            ...
            if(hAdvance==vAdvance && hAdvance==1 && vAdvance==1){
                return true;
            }
            if((java.lang.Math.abs(dR-srcR)<=1 && java.lang.Math.abs(dC-srcC)==0) || (java.lang.Math.abs(dR-srcR)==0 && java.lang.Math.abs(dC-srcC)<=1)){
                return true;
            }
        }
        return false;
